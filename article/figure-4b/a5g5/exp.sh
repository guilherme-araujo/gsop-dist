...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 5000 ephBonus 0.05 ephBonusB 0.05 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads 64 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB 1 bBA 0.95 bBB 0.95 >> a5g5.txt	
