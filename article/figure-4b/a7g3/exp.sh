...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 5000 ephBonus 0.07 ephBonusB 0.03 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads 64 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 0.42857 rBMB 2.3333 bBA 0.95 bBB 0.95 >> a7g3.txt	
