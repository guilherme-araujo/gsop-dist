...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 5000 ephBonus 0.01 ephBonusB 0.09 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads 64 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 9 rBMB 0.1111 bBA 0.95 bBB 0.95 >> a1g9.txt	
