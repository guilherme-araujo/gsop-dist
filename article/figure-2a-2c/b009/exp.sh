...
do
	...
	./$FILE samples 5000 ephBonus 0.09 ephBonusB 0.0 ephStartRatio 0.50 ephBuildingRatio 0.0 ephReusingRatio 0.0 ephPopHistory 0 threads 72 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB -1 bBA -1 bBB -1 bEph 0 ephBirthGenChance 0.5 >> b009.txt	
