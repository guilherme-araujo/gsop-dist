...
do
	...
	./$FILE samples 5000 ephBonus 0.04 ephBonusB 0.02 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads 72 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 0.5 rBMB 1 bBA 0.97 bBB 0.97 >> b4g2.txt	
